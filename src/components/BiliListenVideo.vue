      ...
      <div class="container p-6 border border-gray-200 rounded-lg shadow bg-white">
        ...
        <div>
          <div class="flex items-center justify-between my-4 p-2">
            ...
            <div v-if="audioUrl" class="text-gray-500 text-sm truncate">
          ...
          <ul v-if="audioList.length !== 0" class="divide-y divide-gray-200 overflow-auto h-80">
            <li v-for="(audio, index) in audioList" :key="audio.cid" class="flex flex-row justify-between items-center p-2">
              ...
              <div class="flex flex-row items-center gap-2">
                <button type="button" class="p-2.5 rounded-full border border-gray-300 hover:bg-gray-100" @click="() => handlePlay(audio, index)">
                ...
                <button type="button" class="p-2.5 rounded-full border border-gray-300 hover:bg-gray-100" @click="() => handleOpenLink(audio)">
                  <svg class="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.213 9.787a3.391 3.391 0 0 0-4.795 0l-3.425 3.426a3.39 3.39 0 0 0 4.795 4.794l.321-.304m-.321-4.49a3.39 3.39 0 0 0 4.795 0l3.424-3.426a3.39 3.39 0 0 0-4.794-4.795l-1.028.961" />
                  </svg>
                </button>
                <button type="button" class="p-2.5 rounded-full border border-gray-300 hover:bg-gray-100" @click="() => handleDeleteAudio(index)">
                  <svg class="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
